Ext.define(MyIndo.getNameSpace('view.Kredit.PencairanKredit.Detail'), {
	extend: 'Ext.Window',
	alias: 'widget.detailpencairankredit',
	modal: true,
	resizable: false,
	...
	initComponent: function() {
		...
		Ext.apply(this, {
			items: [{
				xtype: 'form',
				layout: 'hbox',
				id: 'pencairankredit-add-update-form',
				border: false,
				bodyPadding: '5 0 5 5',
				margin: '0 0 -10 0',
				width: 764,
				items: [{
					...
					id: 'pencairankredit-add-update-form-fieldset',
					defaults: {
						width: 340
					},
			...
			buttons: [{
				text: 'Cairkan Kredit',
				iconCls: 'icon-accept',
				action: 'pencairankredit-accept'
			},{
				text: 'Batal',
				action: 'pencairankredit-cancel'
			}]
		});
